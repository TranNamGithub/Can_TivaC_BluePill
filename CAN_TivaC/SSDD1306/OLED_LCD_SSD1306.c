...
static void SSD1306_I2C_WriteMulti(SSD1306_Name* SSD1306, uint8_t address, uint8_t reg, uint8_t* data, uint16_t count) 
{
    ...
    I2C0_sendchar(address, TxBuff, count+1);
...
static void SSD1306_I2C_Write(SSD1306_Name* SSD1306, uint8_t address, uint8_t reg, uint8_t data)
{
	...
	I2C0_sendchar(address, TxBuff, 2);
...
//	SSD1306->I2C = I2C;
    if (I2CMasterBusy(I2C0_BASE)) {
         // I2C bus is busy, return false
         return false;
     }

     // Start the I2C communication
     I2CMasterSlaveAddrSet(I2C0_BASE, SSD1306_I2C_ADDR, false);
     I2CMasterControl(I2C0_BASE, I2C_MASTER_CMD_BURST_SEND_START);


     // Check for errors and device acknowledgment
     if (I2CMasterErr(I2C0_BASE) == I2C_MASTER_ERR_NONE);
         // Device is ready, return true
	/* A little delay */
	uint32_t p = 2500;
	while(p>0)
		p--;
